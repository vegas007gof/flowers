 ...
 */
final class Version20241207165701 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE cart DROP status, DROP created_at, DROP updated_at');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `cart` ADD status INT NOT NULL, ADD created_at INT NOT NULL, ADD updated_at INT NOT NULL');
    }
}
